        ...
        <SidebarHeader>
          <div className="flex w-full items-center justify-between p-2">
            <div className="flex items-center gap-2">
              ...
              <Link href="/dashboard" className="text-xl font-semibold hover:underline group-data-[collapsible=icon]:hidden">Briefly</Link>
            </div>
            ...
            <SidebarMenuItem>
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <SidebarMenuButton size="lg">
                    <Avatar className="size-8">
                     ...
                     <span>{user?.email || 'User'}{user?.role ? ` · ${user.role}` : ''}</span>
                ...
                <DropdownMenuContent className="mb-2 w-56">
                  ...
                  <DropdownMenuSeparator />
                  <DropdownMenuItem onClick={() => { signOut(); if (typeof window !== 'undefined') { window.location.href = '/signin'; } }}>
